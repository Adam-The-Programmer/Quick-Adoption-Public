...
class RegistrationViewModel @Inject constructor(private val registrationRepository: RegistrationRepository) :
    ...
    val name: MutableState<String> = mutableStateOf("Adam")
    val surname: MutableState<String> = mutableStateOf("Piszczek")
    val phone: MutableState<String> = mutableStateOf("+48882705261")
    val country: MutableState<String> = mutableStateOf("Poland")
    val city: MutableState<String> = mutableStateOf("Warsaw")
    val address: MutableState<String> = mutableStateOf("Kmicica 1 /1114")
    val postal: MutableState<String> = mutableStateOf("02-728")
    val email: MutableState<String> = mutableStateOf("adam314pi@gmail.com")
    val password: MutableState<String> = mutableStateOf("123456")
    val retypedPassword: MutableState<String> = mutableStateOf("123456")
    val description: MutableState<String> = mutableStateOf("hello I'm Adam")
